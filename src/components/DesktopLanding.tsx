        ...
        <div className="relative rounded-3xl overflow-hidden" style={{ height: 160 }}>
          <div className="grid grid-cols-4 h-full gap-0.5">
            {[
              ...
              <img key={i} src={src} alt="" loading="eager" decoding="async" className="w-full h-full object-cover" />
            ))}
          </div>
          <div className="absolute inset-0" style={{ background: "linear-gradient(135deg, rgba(131,58,180,0.6) 0%, rgba(253,29,29,0.4) 50%, rgba(252,176,69,0.35) 100%)" }} />

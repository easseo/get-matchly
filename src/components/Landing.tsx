        ...
        <div className="space-y-3">
          {[
            ...
            <div key={s.n} className="flex gap-4 bg-card rounded-3xl p-4 shadow-soft border border-border">
              <div className="shrink-0 w-12 h-12 rounded-2xl bg-brand text-primary-foreground flex items-center justify-center font-black text-lg shadow-glow ltr-num leading-none">
                <span className="block leading-none">{s.n}</span>
              </div>
